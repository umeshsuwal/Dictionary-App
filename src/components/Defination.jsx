...
import { ArrowBack as BackIcon, BookmarkBorder as BookmarkIcon, Bookmark as BookmarkedIcon, VolumeUp as PlayIcon } from "@mui/icons-material"
import { useParams } from "react-router"
import { useNavigate } from 'react-router-dom';
import axios from "axios";

const AlignCenterBox = styled(Box)(({ theme }) => ({ ...theme.mixins.alignInCenter }))
...
useEffect(() => {
  ...
  return (
    ...
    <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{
        mt: 5,
        background: 'linear-gradient(90.17deg, #191E5D 0.14%, #0F133A 98.5%)',
